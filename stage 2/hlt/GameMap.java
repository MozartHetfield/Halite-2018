...
public class GameMap {
    ...
    public Player getEnemy() { //SELF
        for (final Player player : playersUnmodifiable) {
    ...
    public Position returnMagicPosition(Position position) { //SELF
    	return new Position(position.getXPos() - 3, position.getYPos() + 1);
    }
